...
`python3 tests/test_emit.py` (27) — 418 in all. Stdlib only, no dependencies, and `test_docs.py` checks the documentation
...
tests/            418 tests, including the defining law checked exhaustively,
